...
#define CFLOW_STATECHART_RUNTIME_HOOKS_ABI_V3 3u
 ...
 * `staged_state` is a copy-constructed runtime-owned mutable value. The hook
 ...
 * rolls back all staged work and latches `out_error` or a runtime default.
 */
...
typedef struct cflow_statechart_instance_config {
    ...
    /**
     * Optional copied versioned hook table. `runtime_hook_user` remains borrowed
