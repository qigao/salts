 ...
 * creates an independent primitive-IR snapshot suitable for a Subscription. The
 ...
 * rewriting. Subscription scheduling and resource state are outside this layer. */
