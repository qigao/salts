...
spec("CFlow Statechart terminal Runtime adapter") {
    ...
    it("reports stable Source terminal errors and wakes both observers") {
        ...
        void *occupied_self;
        const cflow_publisher_vtable *occupied_vtable;
        int output = 91;
