...
#define cflow_source_from_io_actor cflow_source_from_io_actor_with_init_failure
#define cflow_source_from_io_actor_windowed cflow_source_from_io_actor_windowed_with_init_failure
#define cflow_io_source_owner_run_ready cflow_io_source_owner_run_ready_with_init_failure
#define cflow_io_source_owner_is_quiescent cflow_io_source_owner_is_quiescent_with_init_failure
#define cflow_io_source_owner_get_stats cflow_io_source_owner_get_stats_with_init_failure
#define cflow_io_source_owner_get_window_stats                                                     \
  cflow_io_source_owner_get_window_stats_with_init_failure
#define cflow_io_source_owner_close cflow_io_source_owner_close_with_init_failure
#include "../src/io_source.c"
#undef cflow_io_source_owner_close
#undef cflow_io_source_owner_get_window_stats
#undef cflow_io_source_owner_get_stats
#undef cflow_io_source_owner_is_quiescent
#undef cflow_io_source_owner_run_ready
#undef cflow_source_from_io_actor_windowed
#undef cflow_source_from_io_actor
...
spec("CFlow IO source initialization failures") {
  it("preserves an Actor invalid-configuration error") {
    ...
    const cflow_io_source_config config = {.name = "init-failure",
                                           .type = &cmeta_type_int,
    ...
    check_equal(cflow_source_from_io_actor_with_init_failure(&source, &owner, &config),
                TURBO_EINVAL);
