...
#define SALTS_META_VEC_COLLECTION_DATA(name,type) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),name##_collection_element,name##_collection_read,NULL,name##_collector_erased}; \
...
#define SALTS_META_INDEX_SEQUENCE_DATA(name,type,semantic_kind) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),name##_collection_element,NULL,name##_collection_foreach,name##_collector_erased}; \
