...
#define SALTS_META_VEC_COLLECTION_DATA(name,type) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),CMETA_DATA_COLLECTION_CONTIGUOUS|CMETA_DATA_COLLECTION_ORDERED|CMETA_DATA_COLLECTION_RANDOM_ACCESS,name##_collection_element,name##_collection_read,NULL,name##_collector_erased}; \
...
#define SALTS_META_INDEX_SEQUENCE_DATA(name,type,semantic_kind) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),CMETA_DATA_COLLECTION_ORDERED|CMETA_DATA_COLLECTION_RANDOM_ACCESS,name##_collection_element,NULL,name##_collection_foreach,name##_collector_erased}; \
...
#define SALTS_META_LIST_COLLECTION_DATA(name,type) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),CMETA_DATA_COLLECTION_ORDERED,name##_collection_element,NULL,name##_collection_foreach,name##_collector_erased}; \
 CMETA_LOCAL const cmeta_data_desc name##_collection_data={sizeof(cmeta_data_desc),CMETA_DATA_DESC_ABI_VERSION,#name ".data",#name,CMETA_DATA_SEQUENCE,CMETA_TYPEOF(name),NULL,NULL,NULL,NULL,NULL,NULL,&name##_collection_ops,NULL,&name##_construct_ops}
...
#define SALTS_META_SLOT_SET_COLLECTION_DATA(name,type,prefix,semantic_kind) \
 ...
 CMETA_LOCAL const cmeta_data_collection_ops name##_collection_ops={sizeof(cmeta_data_collection_ops),CMETA_DATA_COLLECTION_OPS_ABI_VERSION,CMETA_TYPEOF(name),CMETA_DATA_COLLECTION_UNIQUE,name##_collection_element,NULL,name##_collection_foreach,name##_collector_erased}; \
 CMETA_LOCAL const cmeta_data_desc name##_collection_data={sizeof(cmeta_data_desc),CMETA_DATA_DESC_ABI_VERSION,#name ".data",#name,semantic_kind,CMETA_TYPEOF(name),NULL,NULL,NULL,NULL,NULL,NULL,&name##_collection_ops,NULL,&name##_construct_ops}
