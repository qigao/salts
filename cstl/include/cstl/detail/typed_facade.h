#ifndef CSTL_DETAIL_TYPED_FACADE_H
#define CSTL_DETAIL_TYPED_FACADE_H
...
#define SALTS_META_VEC_METHODS(M,C) \
...
#define SALTS_META_DEQUE_METHODS(M,C) \
 M(INIT_SIZE,init,raw_init,_,C) M(FROM_ARRAY_SIZE,from,raw_from_array,_,C) \
 M(DESTROY,destroy,raw_destroy_storage,_,C) M(CLEAR,clear,clear,_,C) \
...
#define SALTS_META_STACK_METHODS(M,C) \
 M(INIT_SIZE,init,raw_init,_,C) M(FROM_ARRAY_SIZE,from,raw_from_array,_,C) \
...
#define SALTS_META_QUEUE_METHODS(M,C) \
 M(INIT_SIZE,init,raw_init,_,C) M(FROM_ARRAY_SIZE,from,raw_from_array,_,C) \
 M(DESTROY,destroy,destroy,_,C) M(CLEAR,clear,clear,_,C) \
 M(RESERVE,reserve,reserve,_,C) M(PUSH_VALUE,push,push,_,C) \
...
#define SALTS_META_HEAP_METHODS(M,C) \
...
#define SALTS_META_SET_METHODS(M,C) \
 ...
 M(SIZE,size,size,_,C) M(BOOL,empty,empty,_,C)
#define SALTS_META_HASH_SET_METHODS(M,C) \
...
#define SALTS_META_C1_GENERATION(name,prefix) \
...
#define SALTS_META_C2_GENERATION(name,prefix) SALTS_META_C1_GENERATION(name,prefix)

#define SALTS_META_HASH_MAP_METHODS(M,C) \
...
#define SALTS_META_MAP_METHODS(M,C) \
...
#define SALTS_META_MULTIMAP_METHODS(M,C) \
...
#define SALTS_META_TREE_METHODS(M,C) \
...
#define SALTS_META_C1_METHOD_FIND_DISPATCH(kind,pub,op,extra,ctx) \
 SALTS_META_C1_METHOD_FIND_DISPATCH_I( \
   kind,pub,op,extra,CMETA_PP_UNPAREN ctx)
#define SALTS_META_C1_METHOD_FIND_DISPATCH_I(kind,pub,op,extra,...) \
 CMETA_PP_CAT(SALTS_META_C1_METHOD_FIND_,kind)(pub,op,extra,__VA_ARGS__)

#define SALTS_META_C1_METHOD_FIND_VALUE(pub,op,extra,name,type,type_desc) \
 if (strcmp(method, CMETA_CONTAINER_STR(pub)) == 0) { \
   if (out_function != NULL) *out_function = name##_##pub##_function(); \
   if (out_abi != NULL) *out_abi = name##_##pub##_function_abi(); \
   return true; \
 }

#define SALTS_META_C1_METHOD_FIND_PUSH_VALUE SALTS_META_C1_METHOD_FIND_VALUE
#define SALTS_META_C1_METHOD_FIND_PUSH_VALUE_ITER SALTS_META_C1_METHOD_FIND_VALUE
#define SALTS_META_C1_METHOD_FIND_KEY_VALUE SALTS_META_C1_METHOD_FIND_VALUE
#define SALTS_META_C1_METHOD_FIND_INIT_SIZE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_FROM_ARRAY_SIZE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_DESTROY SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_CLEAR SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_RESERVE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_POP_BOOL SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_PTR_INDEX SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_CONST_PTR_INDEX SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_PTR SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_CONST_PTR SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_SIZE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_BOOL SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_INIT_SIZE_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_FROM_ARRAY_SIZE_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_INIT_KEY_HASH SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_FROM_KEYS_HASH SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_INIT_KEY_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_FROM_KEYS_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_KEY_CONTAINS SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C1_METHOD_FIND_KEY_REMOVE_BOOL SALTS_META_METHOD_REFLECT_SKIP
...
#define SALTS_META_C1_METHOD_METADATA(name,type,type_desc,methods) \
 ...
 CMETA_INLINE bool name##_receiver_method( \
     const char *method, const cmeta_function_desc **out_function, \
     const cmeta_function_abi_desc **out_abi) { \
   if (out_function != NULL) *out_function = NULL; \
   if (out_abi != NULL) *out_abi = NULL; \
   if (method == NULL) return false; \
   methods(SALTS_META_C1_METHOD_FIND_DISPATCH,(name,type,type_desc)) \
   return false; \
 }
...
#define SALTS_META_C2_METHOD_FIND_DISPATCH(kind,pub,op,extra,ctx) \
 SALTS_META_C2_METHOD_FIND_DISPATCH_I( \
   kind,pub,op,extra,CMETA_PP_UNPAREN ctx)
#define SALTS_META_C2_METHOD_FIND_DISPATCH_I(kind,pub,op,extra,...) \
 CMETA_PP_CAT(SALTS_META_C2_METHOD_FIND_,kind)(pub,op,extra,__VA_ARGS__)

#define SALTS_META_C2_METHOD_FIND_PUT( \
    pub,op,extra,name,kt,vt,key_desc,value_desc) \
 if (strcmp(method, CMETA_CONTAINER_STR(pub)) == 0) { \
   if (out_function != NULL) *out_function = name##_##pub##_function(); \
   if (out_abi != NULL) *out_abi = name##_##pub##_function_abi(); \
...
#define SALTS_META_C2_METHOD_FIND_INIT_KV_HASH SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_FROM_ENTRIES SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_DESTROY SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_CLEAR SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_RESERVE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_GET SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_GET_CONST SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_CONTAINS SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_REMOVE_STATUS_BOOL SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_SIZE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_CAPACITY SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_EMPTY SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_KEY_AT SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_KEY_AT_CONST SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_VALUE_AT SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_VALUE_AT_CONST SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_INIT_KV_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_FROM_ENTRIES_LINK SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_INIT_WITH_ORDER_COMPARE SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_INIT_KV_MULTIMAP SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_FROM_ENTRIES_MULTIMAP SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_REMOVE_BOOL SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_COUNT_KEY SALTS_META_METHOD_REFLECT_SKIP
#define SALTS_META_C2_METHOD_FIND_ERASE_KEY SALTS_META_METHOD_REFLECT_SKIP
...
#define SALTS_META_C2_METHOD_METADATA( \
 ...
 CMETA_INLINE bool name##_receiver_method( \
   ...
   if (out_abi != NULL) *out_abi = NULL; \
   if (method == NULL) return false; \
   methods(SALTS_META_C2_METHOD_FIND_DISPATCH, \
           (name,kt,vt,key_desc,value_desc)) \
   return false; \
 }
...
#define SALTS_STL_KIND_SCHEMA(M) Schema(M,SALTS_STL_KIND_ROW_Vec,SALTS_STL_KIND_ROW_Deque,SALTS_STL_KIND_ROW_List,SALTS_STL_KIND_ROW_Stack,SALTS_STL_KIND_ROW_Queue,SALTS_STL_KIND_ROW_Heap,SALTS_STL_KIND_ROW_Set,SALTS_STL_KIND_ROW_HashSet,SALTS_STL_KIND_ROW_HashMap,SALTS_STL_KIND_ROW_Map,SALTS_STL_KIND_ROW_MultiMap,SALTS_STL_KIND_ROW_BTree,SALTS_STL_KIND_ROW_BPlusTree)

#define SALTS_STL_KIND_APPLY(row,name,...) SALTS_STL_KIND_APPLY_E(row,name,__VA_ARGS__)
#define SALTS_STL_KIND_APPLY_E(row,name,...) SALTS_STL_KIND_APPLY_EXPAND(CMETA_PP_UNPAREN row,name,__VA_ARGS__)
#define SALTS_STL_KIND_APPLY_EXPAND(...) SALTS_STL_KIND_APPLY_I(__VA_ARGS__)
...
#define SALTS_STACK_DEFINE(name,type) SALTS_STL_KIND_APPLY(SALTS_STL_KIND_ROW_Stack,name,type) SALTS_META_C1_CONSTRUCT(name,SALTS_STL_STACK_INITIALIZER(type),name##_destroy(self)) SALTS_META_ADAPTER_SEQUENCE_DATA(name,type,stack,CMETA_DATA_SEQUENCE)
#define SALTS_QUEUE_DEFINE(name,type) SALTS_STL_KIND_APPLY(SALTS_STL_KIND_ROW_Queue,name,type) SALTS_META_C1_CONSTRUCT(name,SALTS_STL_QUEUE_INITIALIZER(type),name##_destroy(self)) SALTS_META_ADAPTER_SEQUENCE_DATA(name,type,queue,CMETA_DATA_SEQUENCE)
...
#define SALTS_HASH_MAP_DEFINE(name,k,v) SALTS_STL_KIND_APPLY(SALTS_STL_KIND_ROW_HashMap,name,k,v) SALTS_META_MAP_ACCEPT(name,k,v) SALTS_META_C2_CONSTRUCT(name,SALTS_STL_HASH_MAP_INITIALIZER(k,v),name##_destroy(self)) SALTS_META_HASH_MAP_DATA(name,k,v)
#define SALTS_MAP_DEFINE(name,k,v) SALTS_STL_KIND_APPLY(SALTS_STL_KIND_ROW_Map,name,k,v) SALTS_META_MAP_ACCEPT(name,k,v) SALTS_META_C2_CONSTRUCT(name,SALTS_STL_MAP_INITIALIZER(k,v),name##_destroy(self)) SALTS_META_MAP_DATA(name,k,v)
