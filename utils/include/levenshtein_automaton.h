...
CXX_C_API lev_automaton_t *lev_automaton_create(void);
...
CXX_C_API lev_utf8_automaton_t *lev_utf8_automaton_create(void);

/** Destroys and frees a heap-allocated UTF-8 Levenshtein automaton. */
CXX_C_API void lev_utf8_automaton_free(lev_utf8_automaton_t *lev);
