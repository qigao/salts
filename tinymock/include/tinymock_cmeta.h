 ...
 *
 * Legacy R/V/D rows retain the historical portable TinyMock carrier and
 * invocation ledger. Fully reflected F/FV/FD rows consume the canonical CMeta
 * FunctionDesc/FunctionAbi generated by CMETA_INTERFACE and share the same
 * typed history, output-action, capture and typed-return runtime as reflected
 * free-function mocks.
 */
