...
TURBO_STL_API size_t turbo_hash_bytes(const void *key, size_t key_size, void *ctx);
TURBO_STL_API bool turbo_hash_key_equal(const void *left, const void *right, size_t key_size,
                                        void *ctx);
...
TURBO_STL_API turbo_stl_status turbo_hash_map_init(turbo_hash_map_t *map,
                                                   const cmeta_type_desc *key_type,
                                                   const cmeta_type_desc *value_type,
                                                   size_t entry_limit);
...
TURBO_STL_API turbo_stl_status turbo_hash_map_init_bytes(turbo_hash_map_t *map,
...
TURBO_STL_API turbo_stl_status turbo_hash_map_from_arrays(
...
TURBO_STL_API turbo_stl_status turbo_hash_map_from_arrays_bytes(
    turbo_hash_map_t *map, const void *keys, const void *values, size_t count,
...
TURBO_STL_API void turbo_hash_map_destroy(turbo_hash_map_t *map);
TURBO_STL_API void turbo_hash_map_clear(turbo_hash_map_t *map);
...
TURBO_STL_API turbo_stl_status turbo_hash_map_reserve(turbo_hash_map_t *map,
                                                      size_t min_entries);
TURBO_STL_API turbo_stl_status turbo_hash_map_put(turbo_hash_map_t *map, const void *key,
                                                  const void *value);
/* Returned pointers are borrowed and become invalid after any successful
 * reserve, put, remove, clear, or destroy on this map. */
TURBO_STL_API void *turbo_hash_map_get(turbo_hash_map_t *map, const void *key);
TURBO_STL_API const void *turbo_hash_map_get_const(const turbo_hash_map_t *map, const void *key);
TURBO_STL_API bool turbo_hash_map_contains(const turbo_hash_map_t *map, const void *key);
...
TURBO_STL_API turbo_stl_status turbo_hash_map_remove(turbo_hash_map_t *map, const void *key,
                                                     void *out_value);
TURBO_STL_API size_t turbo_hash_map_size(const turbo_hash_map_t *map);
TURBO_STL_API size_t turbo_hash_map_capacity(const turbo_hash_map_t *map);
TURBO_STL_API size_t turbo_hash_map_entry_limit(const turbo_hash_map_t *map);
TURBO_STL_API uint64_t turbo_hash_map_generation(const turbo_hash_map_t *map);
TURBO_STL_API bool turbo_hash_map_empty(const turbo_hash_map_t *map);
TURBO_STL_API const void *turbo_hash_map_key_at(const turbo_hash_map_t *map, size_t slot);
static inline const void *turbo_hash_map_key_at_const(const turbo_hash_map_t *map,
                                                       size_t slot) {
  return turbo_hash_map_key_at(map, slot);
}
TURBO_STL_API void *turbo_hash_map_value_at(turbo_hash_map_t *map, size_t slot);
TURBO_STL_API const void *turbo_hash_map_value_at_const(const turbo_hash_map_t *map,
                                                        size_t slot);
