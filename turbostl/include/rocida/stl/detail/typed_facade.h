...
#define TURBO_STL_KIND_ROW_Stack (Stack,1,C1_INDEX,turbostl_stack_t,stack,TURBO_META_STACK_METHODS,push,_,_,CMETA_RANGE_SIZED|CMETA_RANGE_ORDERED|CMETA_RANGE_RANDOM_ACCESS|CMETA_RANGE_REUSABLE,0,0,0)
