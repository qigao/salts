...
static inline stl_status queue_init(queue_t *queue,
...
#define turbo_queue_init queue_init
#define turbo_queue_init_bytes queue_init_bytes
#define turbo_queue_from_array queue_from_array
