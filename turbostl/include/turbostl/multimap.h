...
turbo_stl_status turbo_multimap_put(turbo_multimap_t *map,
                                                   const void *key,
                                                   const void *value);
bool turbo_multimap_contains(const turbo_multimap_t *map,
                                           const void *key);
size_t turbo_multimap_count(const turbo_multimap_t *map,
                                          const void *key);
/* remove erases the most recently inserted equivalent pair. */
bool turbo_multimap_remove(turbo_multimap_t *map,
                                         const void *key, void *out_value);
size_t turbo_multimap_erase(turbo_multimap_t *map,
                                          const void *key);
...
turbo_multimap_iter_t turbo_multimap_begin(
    const turbo_multimap_t *map);
turbo_multimap_iter_t turbo_multimap_end(
    const turbo_multimap_t *map);
