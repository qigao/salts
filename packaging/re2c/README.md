...
- `tools/linux-x64/re2c` plus `tools/linux-x64/share/re2c/stdlib/`
- `tools/windows-x64/re2c.exe` plus `tools/windows-x64/share/re2c/stdlib/`
- `tools/macos-x64/re2c` or `tools/macos-arm64/re2c`, each with `share/re2c/stdlib/`
