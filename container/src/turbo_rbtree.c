...
static container_status turbo_rbtree_copy_object(
...
container_status turbo_rbtree_create(
  ...
  *out_tree = NULL;
  ...
  if (tree == NULL) return CONTAINER_OUT_OF_MEMORY;
...
container_status turbo_rbtree_put(turbo_rbtree_t *tree, const void *key,
                                  const void *value,
...
container_status turbo_rbtree_remove_node(turbo_rbtree_t *tree,
                                          turbo_rbtree_node_t *node,
                                          void *out_value) {
  ...
  if (tree == NULL || node == NULL) return CONTAINER_INVALID_ARGUMENT;
