...
CONTAINER_API int turbo_deque_init(turbo_deque_t *deque, size_t elem_size);
/** Initialize deque by copying count elements from a contiguous array in order. */
CONTAINER_API int turbo_deque_from_array(turbo_deque_t *deque, const void *elements, size_t count,
                                     size_t elem_size);
CONTAINER_API void turbo_deque_destroy(turbo_deque_t *deque);
CONTAINER_API void turbo_deque_clear(turbo_deque_t *deque);
CONTAINER_API int turbo_deque_reserve(turbo_deque_t *deque, size_t min_capacity);
CONTAINER_API int turbo_deque_push_back(turbo_deque_t *deque, const void *elem);
CONTAINER_API int turbo_deque_push_front(turbo_deque_t *deque, const void *elem);
CONTAINER_API int turbo_deque_pop_back(turbo_deque_t *deque, void *out_elem);
CONTAINER_API int turbo_deque_pop_front(turbo_deque_t *deque, void *out_elem);
