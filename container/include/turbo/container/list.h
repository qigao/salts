...
CONTAINER_API turbo_list_iter_t turbo_list_begin(const turbo_list_t *list);
CONTAINER_API turbo_list_iter_t turbo_list_end(const turbo_list_t *list);
CONTAINER_API container_status turbo_list_iter_next(turbo_list_iter_t *iterator);
/* prev(end) selects the tail. prev(begin) returns CONTAINER_NOT_FOUND and
 * leaves the iterator unchanged. */
CONTAINER_API container_status turbo_list_iter_prev(turbo_list_iter_t *iterator);
CONTAINER_API bool turbo_list_iter_equal(turbo_list_iter_t left,
                                          turbo_list_iter_t right);
CONTAINER_API void *turbo_list_iter_value(turbo_list_iter_t iterator);
CONTAINER_API const void *turbo_list_iter_value_const(
