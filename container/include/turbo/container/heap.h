...
CONTAINER_API int turbo_heap_init(turbo_heap_t *heap, size_t elem_size,
                              turbo_heap_compare_fn compare, void *compare_ctx);
/** Initialize a heap by copying and heapifying count contiguous elements. */
CONTAINER_API int turbo_heap_from_array(turbo_heap_t *heap, const void *elements, size_t count,
                                    size_t elem_size, turbo_heap_compare_fn compare,
                                    void *compare_ctx);
CONTAINER_API void turbo_heap_destroy(turbo_heap_t *heap);
CONTAINER_API void turbo_heap_clear(turbo_heap_t *heap);
CONTAINER_API int turbo_heap_reserve(turbo_heap_t *heap, size_t min_capacity);
CONTAINER_API int turbo_heap_push(turbo_heap_t *heap, const void *elem);
CONTAINER_API int turbo_heap_pop(turbo_heap_t *heap, void *out_elem);
