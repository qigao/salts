...
**Architecture:** Concurrency supplies stable thread-pool error codes; CFlow maps them to one admission enum. ManualExecutor and TimerQueue preallocate fixed arrays, while WorkerExecutor reuses the existing bounded thread pool. Checked methods are authoritative and legacy bool/id methods delegate to them.
...
- [ ] **Step 3: Return stable errors from the existing state machine**
...
- [ ] **Step 4: Run Concurrency owner tests**
...
- [ ] **Step 1: Add failing checked-admission tests**
...
- [ ] **Step 3: Add the public enum and checked methods**
...
- [ ] **Step 4: Verify source compatibility**
...
- [ ] **Step 1: Add capacity boundary and allocation-count tests**
...
- [ ] **Step 3: Preallocate exact arrays**
...
- [ ] **Step 4: Wire named defaults and WorkerExecutor capacity**
...
- [ ] **Step 1: Add deterministic saturated-handoff tests**
...
- [ ] **Step 2: Run the tests and confirm the current loss bug**
...
- [ ] **Step 3: Implement accepted-task terminal states**
...
- [ ] **Step 4: Run shutdown and runtime regression tests**
...
- [ ] **Step 1: Document migration and resource budget**
...
- [ ] **Step 2: Run verification in increasing scope**
